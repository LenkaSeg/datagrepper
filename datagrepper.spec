...
Name:           %{pypi_name}
Version:        1.0.0
Release:        5.20220513093908963333.spec.73.g3145ea8%{?dist}
...
mkdir -p %{buildroot}%{_datadir}/%{pypi_name}/apache/
install -m 644 apache/%{pypi_name}.wsgi %{buildroot}%{_datadir}/%{pypi_name}/apache/%{pypi_name}.wsgi
install -m 644 apache/%{pypi_name}.conf %{buildroot}%{_datadir}/%{pypi_name}/apache/%{pypi_name}.conf
...
%doc README.md %{pypi_name}/docs
%license COPYING
%config(noreplace) %{_sysconfdir}/%{pypi_name}/
%config(noreplace) %{_datadir}/%{pypi_name}/apache/%{pypi_name}.conf
%{_datadir}/%{pypi_name}/apache/%{pypi_name}.wsgi

%changelog
* Fri May 13 2022 Lenka Segura <lsegura@redhat.com> - 1.0.0-5.20220513093908963333.spec.73.g3145ea8
- new version
